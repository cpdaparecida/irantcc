                ...
                <li class="">
                  <?php
                    if(strcmp(isset($_COOKIE['funcao']) ? $_COOKIE['funcao']: $_SESSION['funcao'], "Diretoria") == 0)
                      echo "<a href=\"hospitais.php\" class=\"waves-effect waves-cyan\">
                      <i class=\"material-icons\">local_hospital</i>
                      <span class=\"nav-text\">".(isset($_COOKIE['hospital']) ? $_COOKIE['funcao'] : $_SESSION['hospital'])."</span>
                    </a> ";
                    if(isset($_COOKIE['funcao'])){
                    if (strcmp($_COOKIE['funcao'], "Medico") == 0) {
                      echo "<div class=\"collapsible\">
                      <div class=\"collapsible-header\">
                        <i class=\"material-icons\">local_hospital</i>
                        <span class=\"nav-text\">Hospitais</span>
                      </div>";
                      foreach ($_COOKIE['hospitais'] as $key => $value) {
                        echo "<div class=\"collapsible-body\">
                                <span class=\"nav-text\">".$_COOKIE["'hospitais[".$key."]'" ]."</span>
                              </div>";
                      }
                      echo "</div>";
                    }
                    ...
                    if (isset($_SESSION['funcao'])) {
                      # code...
                      if (strcmp($_SESSION['funcao'], "Medico") == 0) {
                      echo "<div class=\"collapsible\">
                      <div class=\"collapsible-header\">
                        <i class=\"material-icons\">local_hospital</i>
                        <span class=\"nav-text\">Hospitais</span>
                      ...
                      foreach ($_SESSION['hospitais'] as $key => $value) {
                        echo "<div class=\"collapsible-body\">
                                <span class=\"nav-text\">".$_SESSION['hospitais'][$key]."</span>
                              </div>";
                      }
                      echo "</div>";
                    }
