<?php
  ...
  $vaga = DBRead('info_hospitais', null, 'hospital, lat, log, cardiacos');
...
<?php
  $hospital = "\n";
        ...
        for($i = 0;$i < count($vaga); $i++){
          ...
          $hospital .= "vaga: {$vaga[$i]['cardiacos']},\n\t\t\t";
            if ($vaga[$i]['cardiacos'] < 4) {
             $hospital .= "cor: '#F4415B' }";
            }
            else if ($vaga[$i]['cardiacos'] < 7) {
             $hospital .= "cor: '#F4D742' }";
            }
            else if ($vaga[$i]['cardiacos'] < 10) {
             $hospital .= "cor: '#4195F4' }";
            }
            else {
             $hospital .= "cor: '#42F4B9' }"; 
