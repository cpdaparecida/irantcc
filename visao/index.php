...
<html lang="pt-br">
        ...
        <nav class="navbar-color gradient-45deg-light-blue-cyan">
          <div class="nav-wrapper">
            ...
            <div class="header-search-wrapper hide-on-med-and-down">
              ...
              <input type="text" name="Search" class="header-search-input z-depth-2" placeholder="Procurar" />
            </div>
      ...
      <div class="col s12 z-depth-2 card-panel"> 
        <div class="row margin">
         <div class="input-field col s6 offset-s3">
          <input type="text" name="pesquisa" id="pesquisar"  class="autocomplete hide-on-med-and-down" onkeyup="chamaIframe()">
          <input type="text" name="pesquisa" id="pesquisar" placeholder="Queimados" class="autocomplete hide-on-large-only" onkeyup="chamaIframe()">
          <label for="pesquisa" class="hide-on-med-and-down">Pesquise uma Especialidade</label>
         </div>
        </div>
        <div class="divider"></div>
        <div class="card-content">
          <br>
          <iframe  id="iframe-mapa" src="mapa.php" frameborder="0" height="440px" width="100%" ></iframe>
        </div>
       </div>
     </div>
    </div>
  ...
  <script type="text/javascript" > 
        ...
        var queimados = "Queimados";
        var cardiacos = "Cardiacos";
        var obstetrica = "Obstetrica";
        var ortopedica = "Ortopedica";



        function chamaIframe(){
          if(queimados.indexOf(document.getElementById('pesquisar').value) != -1)
            iframe.src = "mapa-queimados.php";
          else if(cardiacos.indexOf(document.getElementById('pesquisar').value) != -1) 
            iframe.src = "mapa-cardiacos.php";
          else if(obstetrica.indexOf(document.getElementById('pesquisar').value) != -1) 
            iframe.src = "mapa-obstetrica.php";
          else if(ortopedica.indexOf(document.getElementById('pesquisar').value) != -1)
            iframe.src = "mapa-ortopedica.php";
          else
            iframe.src = "mapa.php";
        }
     </script>
