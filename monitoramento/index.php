...
<html lang="pt-br">
  <head>
    ...
    <title>IranTCC | Monitoramento</title>
    <!-- Favicons-->
    ...
    <link href="../vendors/animate-css/animate.css" type="text/css" rel="stylesheet">
  ...
  <body>
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="../estatisticas/" class="waves-effect waves-cyan">
                ...
                <li class="bold">
                  ...
                  if(strcmp(isset($_COOKIE['funcao']) ? $_COOKIE['funcao']: $_SESSION['funcao'], "Diretoria") == 0){
                    ...
                    <div class=\"collapsible-body\">
                      ...
                      <a href=\"../hospital/otavio-de-freitas.php\" class=\"collection-item center\">Oswaldo Cruz</a>
                ...
                <li class="bold">
                  <a href="../contatos/" class="waves-effect waves-cyan">
                    <i class="material-icons">contatos</i>
   ...
   <section id="content">
     <div class="container">
        <div class="row mt-1">
          <div class="col s12 m12 l12">
           <h5 id="titulo">Ultimas Mudanças</h5> 
          </div>
        </div>
      <div class="divider"></div>
        <div class="row mt-2" id="linha_ultimas">
        </div>
      <div class="row" >
        <div class="col s12" >
          <div class="card z-depth-5">
            <h4 class="card-title pb-0 pt-2 pr-2 pl-2">
             Monitoramento
              <a href="#" id="especialidade" class="right waves-effect waves-block waves-light dropdown-settings" data-activates="lista">Queimaduras</a>
              <ul id="lista" class="dropdown-content">
                <li>
                  <a href="#" class="grey-text"><i class="material-icons">flare</i>Queimaduras</a>
                </li>
                <li>
                  <a href="#" class="grey-text"><i class="material-icons">favorite</i>Vascular</a>
                </li>
                <li>
                  <a href="#" class="grey-text"><i class="material-icons">directions_walks</i>Traumato</a>
                </li>
                <li>
                  <a href="#" class="grey-text"><i class="material-icons">pregnant_woman</i>Obstetrícia</a>
                </li>
              </ul>
            </h4> 
            <p class="medium-small pl-2 grey-text">Monitoramento de Vagas</p>
          <div id="myChartQueimados" class="padding-2 pb-3">
             <canvas id="ChartQueimados" width="100%" ></canvas>
          </div>
        </div>  
        </div>
      </div>
    ...
    <script type="text/javascript" src="../js/plugins-alternativo.js"></script>
    <!--custom-script.js - Add your own theme custom JS-->
    <script type="text/javascript" src="../js/custom-script.js"></script>  
    <script type="text/javascript" src="../Chart.js-2.7.3/Chart.js-2.7.3/dist/Chart.js"></script>  
    <script type="text/javascript" src="../js/jquery-sparkline.js" ></script>
    <!-- Script para colocação das ultimas mudanças -->
    <script type="text/javascript" src="js/script_novas.js" ></script>
    <!-- Script para Geração do grafico -->
    <script type="text/javascript" src="js/script_monitoramento.js"></script>
